...
select property_type, count(id) as id, max(date_reviewed) as date_reviewed
from (
        select a.property_type as property_type, b.id as id, b.date_reviewed as date_reviewed
        from listings a
